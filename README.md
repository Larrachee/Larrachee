...
<table align="center">
  <tr>
    <td width="50%" valign="top">
      <h4>🛠️ Projects in Orbit</h4>
      <ul>
        <li><b>NAS Architect:</b> High-availability storage with <b>CasaOS</b> & Docker.</li>
        <li><b>Embedded System:</b> Whack-A-Mole game logic using <b>STM32 Blue Pill</b>.</li>
        <li><b>HabitRiver:</b> Building a high-performance habit tracker with React.</li>
      </ul>
    </td>
    <td width="50%" valign="top">
